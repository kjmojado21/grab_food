<?php
$personAge = array(25 => 'Tomonori', 22 => 'Shodai', 27 => 'Shota', 30=>'Hotaka');
    ...
    <div class="card w-50 mx-auto mt-5">
        ...
        <div class="card-body">
            ...
            <select name="choosen_name" id="" class="form-control">
                    ...
                    <option value='25'><?php echo $personAge[25]?></option>
                    <option value="22"><?php echo $personAge[22]?></option>
                    <option value="27"<?php echo $personAge[27]?>><?php echo $personAge[27]?></option>
                    <option value="30"><?php echo $personAge[30]?></option>
