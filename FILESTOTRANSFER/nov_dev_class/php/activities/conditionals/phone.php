...
<?php
    ...
    if (isset($_POST["calculate"])){
        ...
        function checkInputs($day_start_hour, $day_start_min, $day_end_hour, $day_end_min, $night_start_hour, $night_start_min, $night_end_hour, $night_end_min){
            if(($day_start_hour >= 1 && $day_start_hour <= 17) && ($day_start_min >= 0 && $day_start_min <= 59) && ($day_end_hour >= 1 && $day_end_hour <= 17) && ($night_start_hour >= 18 && $night_start_hour <= 24) && ($night_start_min >= 0 && $night_start_min <= 59) && ($night_end_hour >= 18 && $night_end_hour <= 24) && ($day_start_hour < $day_end_hour) && ($night_start_hour < $night_end_hour)){
