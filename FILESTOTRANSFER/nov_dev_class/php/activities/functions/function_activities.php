...
function user_input($name, $age, $username, $password, $email)
{
    ...
    echo "<div class = 'alert alert-success text-uppercase text-center'>Your Name is: <strong>" . $age."</strong></div>";
   
    echo "<div class = 'alert alert-success text-uppercase text-center'>Your Name is: <strong>" . $username."</strong></div>";
    
    echo "<div class = 'alert alert-success text-uppercase text-center'>Your Name is: <strong>" . $password."</strong></div>";
    
    echo "<div class = 'alert alert-success text-uppercase text-center'>Your Name is: <strong>" . $email."</strong></div>";
}
    ...
    <div class="container">
        <div class="card w-50 mx-auto mt-5">
            ...
            <div class="form-group">
                ...
                <button class="btn btn-outline-danger btn-block" type="User Basic Information" name="basic">Basic Information</button>
                <button class="btn btn-outline-warning btn-block" type="User Basic Information" name="security">Generate Username and Password</button>
